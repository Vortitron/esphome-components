...
void EthernetComponent::setup() {
  ...
  // Install GPIO ISR handler to be able to service SPI Ethernet module interrupts
  ...
  spi_device_interface_config_t devcfg = {
      ...
      .cs_ena_pretrans = 0,
      .cs_ena_posttrans = 0,
      .clock_speed_hz = this->clock_speed_,  // Use the configured clock speed
      .input_delay_ns = 0,
      .spics_io_num = this->cs_pin_,
      .flags = SPI_DEVICE_NO_DUMMY,  // No dummy cycles for W5500
      .queue_size = 20,
      .pre_cb = nullptr,
      .post_cb = nullptr,
  };
